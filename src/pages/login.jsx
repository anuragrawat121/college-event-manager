...
export default function Login({ onLogin, onForgotPassword }) { // <--- ADDED PROP
        ...
        <div className="min-h-screen bg-[#F7F8FA] flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md border border-gray-100">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#3B82F6] appearance-none bg-white cursor-pointer"
                            >
                    ...
                    <button
                        type="submit"
                        className="w-full bg-[#3B82F6] hover:bg-[#2563EB] text-white font-semibold py-2.5 rounded-lg transition-colors mt-2 shadow-md"
                    >
                        Login
                    </button>
                </form>

                {/* Footer Link - NOW ACTIVE */}
                <div className="mt-6 text-center">
                    <button
                        onClick={onForgotPassword} // <--- CONNECTED HERE
