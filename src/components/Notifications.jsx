...
import { Bell, Send, Trash2, Check, AlertCircle } from 'lucide-react';

export function Notifications({ darkMode }) {
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className={`${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Manage system alerts and announcements</p>
                </div>
